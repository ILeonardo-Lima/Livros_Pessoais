...
import LivroListaItem from "./LivroListaItem";
...
function LivroCard({
  ...
  const cardTheme = darkMode
    ? "bg-zinc-900 border-zinc-800 text-white hover:shadow-2"
    : "bg-white border-gray-300 text-gray-900 hober:shadow-blue-300";
