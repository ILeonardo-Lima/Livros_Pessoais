...
const LivroListaItem = ({
  ...
  return (
    <div
      ...
      className={`relative flex flex-row items-start gap-4 p-4 border-b transition-all ${
    ...
    >
      ...
      <div className="flex-1 min-w-0 flex flex-col h-full">
        <h3
          className={`text-[13px] font-bold line-clamp-2 w-full pr-2 md:text-sm md:pr-0 ${darkMode ? "text-zinc-100" : "text-zinc-900"}`}
        >
          {livro.titulo}
        </h3>
